  ...
  <main class="max-w-7xl mx-auto px-4 py-8">
    <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
      ...
      <div class="bg-white rounded-lg shadow-md p-6 md:col-span-2">
        <h2 class="text-xl font-bold">Welcome back, <?php echo htmlspecialchars($_SESSION["firstname"]); ?>!</h2>
      ...
      <div class="bg-white rounded-lg shadow-md p-6 md:col-span-2 lg:col-span-3">
        ...
        <a href="deposit.html" class="inline-flex items-center bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition">
          ➕ Deposit Funds
        </a>
      </div>
